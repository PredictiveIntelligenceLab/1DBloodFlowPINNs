...
velo1_DG = np.load("velo_aorta1_ref1.npy").item()
velo2_DG = np.load("velo_aorta1_ref2.npy").item()
velo3_DG = np.load("velo_aorta1_ref3.npy").item()
velo4_DG = np.load("velo_aorta1_ref4.npy").item()
